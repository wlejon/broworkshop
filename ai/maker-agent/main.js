...
const MAKER_SYSTEM_PROMPT = [
    ...
    "entry point) plus any `style.css`, `script.js`, or assets it needs.",
    "ALWAYS write `index.html` BEFORE your first `look` — the preview is empty until an index.html exists, and `look`",
    "will just tell you nothing has rendered yet.",
