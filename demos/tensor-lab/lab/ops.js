...
//
// The Attention and T5 ops live in lab/ops-attention.js and register here
// through registerAttentionOps(), with the helpers below passed in.
import { Shape } from "/app/lab/shape.js";
import { registerAttentionOps } from "/app/lab/ops-attention.js";
  ...
  // === Attention + T5 encoder (lab/ops-attention.js) ====================
  registerAttentionOps({ def, cached, weight, constant, boundW, needMatrix });
