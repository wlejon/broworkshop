...
// (ESM: import the app's exported lib/ symbols — absolute /app/ mount → the SAME
// instances the app loaded. qwen/variant are app state, set via the seams.)
import { setQwen, setVariant, adaptToVariant, qwen, variant } from "/app/lib/model.js";
import { bargeIn, voiceSteerVector } from "/app/lib/synth.js";
import { mascFemBasis, setMfAlpha, resetMascFem } from "/app/lib/mascfem.js";
import { voiceBasis, designedXvec, seedVoice, snapToPoint } from "/app/lib/designer.js";
...
setVariant(qwen.variant); adaptToVariant();
...
setQwen(bro.tts.loadQwen(ROOT + '/0.6B-customvoice')); setVariant(qwen.variant); adaptToVariant();
