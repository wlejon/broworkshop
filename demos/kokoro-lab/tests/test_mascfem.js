...
import { kokoro, putKokoro, basis, putBasis, mascFemBasis, putMascFemBasis,
         putCoords, mfVal, mfAlpha, voice, $ } from "/app/lib/state.js";
...
putKokoro(bro.tts.loadKokoro(MODEL));
putBasis(JSON.parse(fs.readFileSync(MODEL + '/voice_basis.json', 'utf8')));
putMascFemBasis(JSON.parse(fs.readFileSync(MODEL + '/masc_fem_basis.json', 'utf8')));
putCoords(new Float64Array(basis.k));               // neutral designed voice (basis mean)
