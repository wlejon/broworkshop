import { $, activeDrag, curDur, dirty, kokoro, lastTrace, putActiveDrag, putCurDur, putEdited, putProtectedStage, putRenderTimer, putSynthBusy, renderTimer, synthBusy, voice } from "/app/lib/state.js";
import { setBadge } from "/app/lib/model.js";
import { pump } from "/app/lib/synth.js";
import { renderStagesLight, scheduleHeatRefresh, selectPhoneme } from "/app/lib/render.js";
import { capturePinnedEdit, resampleByDur, resetDurations } from "/app/lib/edit.js";
...
export function updateAlignCell(cells, i) {
...
export function applyDuration(r, newDur, asrP, F0p, Np, totalP, L) {
...
export function renderAlign(body, s) {
...
export function wireAlignCell(cell, cells) {
  ...
  cell.addEventListener('mousedown', (e) => {
    ...
    putActiveDrag({ cells, i, y0: e.clientY, base: durWork[i], moved: false });
  });
}
...
export function onDurUp() {
  const d = activeDrag; putActiveDrag(null); if (!d) return;
