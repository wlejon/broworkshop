...
//     while rotating.
//
// Usage: loading the file defines globalThis.BotAim, so it works both as a
// classic <script src="/lib/bot_aim.js"> and as a side-effect import from a
// module (a server script or worker):
...
})(globalThis.BotAim = globalThis.BotAim || {});
