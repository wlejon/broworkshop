...
//
// Used by the match / fall puzzles (gemswap, fluffshuffle, wordspire) and, for
// fitBoard and the cell geometry, by the board-drawn classics (snake, chomper,
// hopper). Seeded randomness is random.js; the "m:ss" clock is timers.js.
