// lib/tot_reasoning.js — Tree-of-Thought MCTS reasoning for Bronze JavaScript applications.
// Integrates bro.game.createGenericMcts (PUCT search) with LLM / heuristic thought generation.
...
export function searchTreeOfThoughts(options) {
    ...
    const hasNativeMcts = typeof bro !== 'undefined' && bro.game && typeof bro.game.createGenericMcts === 'function';
    ...
    for (let depth = 0; depth < maxDepth; depth++) {
        ...
        if (hasNativeMcts) {
            const mcts = bro.game.createGenericMcts({
                env,
                numActions: branchingFactor,
                iterations,
                cPuct,
