 ...
 * `transfer` (optional) moves ArrayBuffers / ImageBitmaps instead of copying.
 */
export function emit(type, fields, transfer) {
    self.postMessage(Object.assign({ type }, fields), transfer || []);
}
