...
/**
 * querySelector that throws when the selector matches nothing. An element
 * passes straight through, so kit widgets take "selector or element" via $.
 */
...
/** A duration in seconds as "m:ss.s" (`digits` decimals, default 1). */
