// tank.js — Fintank domain: day loop, shop, tank entities, draw.
// No arcade plugin / shell wiring — that lives in game.js.
...
export function startGame(slotN) {
...
export function resetSlotForRetry() {
    slot.fish = [{ tier: 1 }, { tier: 1 }];
    slot.day = 1;
...
export function drawTank(dctx, Wd, Hd) {
    computeLayout(Wd, Hd);
...
export function drawBg(ctx, Wd, Hd) {
    bgT += 16;
...
export function attachPointer(view) {
...
// ── Plugin bridge (set from game.js) ─────────────────────────────────────

export function setPlay(fn) { _play = fn || function () {}; }
export function playCue(name) { _play(name); }
export function setShellRef(ref) { shellRef = ref; }
export function getShellRef() { return shellRef; }
export function getSlot() { return slot; }
export function getFish() { return fish; }
export function getDayTimer() { return dayTimer; }
export function getDayMs() { return DAY_MS; }
export function getNextStatus() { return nextStatus; }
