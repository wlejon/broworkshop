...
// After all surgery, pair every half-edge that has no twin with the
// opposite half-edge between the same two POSITIONS. Twins span face groups,
// so this fixes up the bridges' connections to existing geometry. Positions,
// not vertex objects: two distinct vertices may sit at the same point (a
// cap-rim duplicate of a wall vertex).
